...
## [0.1.0-alpha.3](https://github.com/kent8192/reinhardt-cloud/compare/reinhardt-cloud-grpc@v0.1.0-alpha.2...reinhardt-cloud-grpc@v0.1.0-alpha.3) - 2026-09-16

### Security

- *(grpc)* authenticate deployed agent service RPCs
