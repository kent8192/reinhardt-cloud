...
//! generated by `reinhardt-cloud init` and provides conversion to `ProjectSpec`.
...
use crate::crd::{
	...
	ScaleMetric, ScaleSpec, ServiceTlsSpec, ServicesSpec, SourceSpec, StorageBackend, StorageSpec,
...
pub struct AppSection {
	/// Project name used as the CRD resource name
	pub name: String,
...
impl ReinhardtCloudToml {
	/// Converts this configuration to a `ProjectSpec` for CRD creation.
	///
	...
	pub fn to_project_spec(&self) -> ProjectSpec {
		ProjectSpec {
...
"#;
	...
	#[rstest]
	fn test_reinhardt_cloud_toml_to_project_spec() {
		// Arrange
